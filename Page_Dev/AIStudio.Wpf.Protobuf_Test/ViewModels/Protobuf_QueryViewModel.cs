...
using AIStudio.Wpf.BasePage.Protobuf.ViewModels;
...
{
    class Protobuf_QueryViewModel<T, Q> : ProtobufWindowViewModel<T> where T : class, IIsChecked, new()
    {
        ...
        public Protobuf_QueryViewModel(string area, Type type, string getDataList = "GetDataList") : base(area, type, typeof(Common_QueryEdit), getDataList)
        {
        ...
        {
            BaseControlItem.ListToObject(viewmodel.Data, ((Protobuf_QueryEditViewModel<T>)viewmodel).EditFormItems);
