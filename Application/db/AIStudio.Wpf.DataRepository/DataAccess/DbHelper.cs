...
namespace AIStudio.Wpf.DataRepository
{
    ...
    public abstract class DbHelper
    {
        ...
        /// <returns></returns>
        public abstract List<AIStudio.Core.DbTableInfo> GetDbAllTables(string schemaName = null);
        ...
        /// <returns></returns>
        public abstract List<AIStudio.Core.TableInfo> GetDbTableInfo(string tableName);
