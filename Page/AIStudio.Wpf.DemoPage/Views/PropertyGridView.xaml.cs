...
namespace AIStudio.Wpf.DemoPage.Views
{
    ...
    public partial class PropertyGridView : UserControl
    {
        public PropertyGridView()
        {
            ...
            {
                var range = new AIStudio.Wpf.DemoPage.Models.Range();
                range.IntText = 1;
        ...
        private void OnPreparePropertyItem(object sender, Util.Controls.Xceed.PropertyGrid.PropertyItemEventArgs e)
        {
