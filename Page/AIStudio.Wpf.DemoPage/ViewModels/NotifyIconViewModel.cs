...
{
    public class NotifyIconViewModel : DockWindowViewModel
    {
        ...
        private bool _contextMenuIsShow0;

        public bool ContextMenuIsShow0
        {
            get { return _contextMenuIsShow0; }
            set
            {
                if (_contextMenuIsShow0 != value)
                {
                    _contextMenuIsShow0 = value;
                    RaisePropertyChanged("ContextMenuIsShow0");
                    WindowBase.SetWindowStatus("ShowNotifyIcon", "RootWindow");
                }
            }
        }

        private bool _contextMenuIsBlink0;

        public bool ContextMenuIsBlink0
        {
            get { return _contextMenuIsBlink0; }
            set
            {
                if (_contextMenuIsBlink0 != value)
                {
                    _contextMenuIsBlink0 = value;
                    RaisePropertyChanged("ContextMenuIsBlink0");
                    WindowBase.SetWindowStatus("NotifyIconBlink", "RootWindow");
                }
            }
        }
