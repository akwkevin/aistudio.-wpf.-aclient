...
using Util.Controls.Handy.Tools.Converter;
        ...
        private static List<DemoItemModel> Convert2DemoItemList(dynamic list)
        {
            ...
            foreach (var item in list)
            {
                ...
                resultList.Add(new DemoItemModel
                {
                    ...
                    ImageName = $"/AIStudio.Wpf.DemoPage;component/Resources/Img/LeftMainContent/{(string.IsNullOrEmpty(imageName) ? "Star" : imageName)}.png",
                    IsNew = isNew
                });
            }
